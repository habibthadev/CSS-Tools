...
export default function Padding() {
  ...
  return (
    <>
      <SEOMeta title="Padding" description="CSS padding generator with shorthand output." path="/tools/padding" />
      <ToolLayout
        name="Padding"
        category="Box Model"
        description="Control inner spacing on all four sides"
        declarations={[{ property: 'padding', value: shorthand() }]}
        preview={
          <div className="spacing-demo">
            <div
              className="spacing-demo__outer"
              style={{ padding: shorthand() }}
            >
              <div className="spacing-demo__inner">box</div>
            </div>
          </div>
        }
      >
